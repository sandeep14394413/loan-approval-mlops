...
from src.data_preprocessing import build_preprocessor, get_features_and_target, clean_target
...
def run_training():
    ...
    # Save metrics JSON for downstream stages
    metrics_out = {
    ...
    for name, metrics in results.items():
        ...
        lines.append(f"| F1 Score  | {metrics['f1_score']}  | {metrics['cv_f1_mean']} ± {metrics['cv_f1_std']} |\n")
